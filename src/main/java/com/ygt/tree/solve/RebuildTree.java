...
public class RebuildTree {
    ...
    public NormalTreeNode reConstructBinaryTree(int[] pre, int[] in) {
    ...
    private NormalTreeNode reConstructBinaryTree(int[] pre, int preL, int preR, int inL) {
        if (preL > preR){
            return null;
        }
        NormalTreeNode root = new NormalTreeNode(pre[preL]);
